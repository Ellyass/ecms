...
<div class="wrapper">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview active">
                    <a href="#"><i class="fa fa-users"></i> <span>Yönetim</span>
                ...
                <li class="treeview active">
                    <a href="#"><i class="fa fa-bars"></i> <span>Genel Ayarlar</span>
                        <span class="pull-right-container">
                                <i class="fa fa-angle-left pull-right"></i>
                        </span>
                    </a>
                    <ul class="treeview-menu">
                        ...
                        <li><a href="{{route('blog.index')}}"><i class="fa fa-pencil-square"></i> <span>Blog</span></a></li>
                        <li><a href="{{route('page.index')}}"><i class="fa fa-file"></i> <span>Page</span></a></li>
                        <li><a href="{{route('slider.index')}}"><i class="fa fa-camera-retro"></i> <span>Slider</span></a></li>
                    </ul>
                </li>
    ...
    <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Elyesa Aydemir &copy; 2022 <a href="#">NE</a></strong> Tüm haklar saklıdır.
    </footer>
